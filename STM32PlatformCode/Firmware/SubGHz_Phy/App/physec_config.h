...
//
// The packet is a simple structure with a magic number, a type and a data
// field. The type of the header helps to determine the size of the data field.
// The data field allows encapsulating another struct representing the packet
// payload. If the payload has a variable size, it embeds an additional header
